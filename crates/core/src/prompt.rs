...
mod tests {
    ...
    fn minimal_instructions_are_the_header_and_one_pointer_sentence() {
        ...
        assert_eq!(
            text,
            "CRYSTALLINE KNOWLEDGE ROUTING\n\nCrystalline is your crystallized intelligence across sessions and your session hook has already delivered its full routing block; call list_domains with include_routing=true to fetch the domain index and its behavior rules again at any time.\n"
        );
