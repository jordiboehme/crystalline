...
pub use store::{
    ...
    GraphEdge, GraphNode, GraphSlice, HitKind, HostClaim, InboundHit, InboundPage, InboundQuery,
    InboundRef, LEXICAL_CANDIDATE_CAP, LINKS_TO, MetadataFilter, NamedCount, NewChunk, OutboundRef,
    Page, RETIRED_STATUSES, RecentFilter, SearchHit, SearchMode, SearchQuery, Store, StoreInfo,
