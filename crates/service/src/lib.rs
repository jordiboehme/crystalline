...
pub use client::{
    ...
    domain_import, domain_remove, origin_add, origin_resolve, origin_share, origin_status,
    origin_update, origin_withdraw, run_mcp, run_tool, scaffold_virtual_manifest, tags_retag,
