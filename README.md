...
- **Hello · Hallo · Hola · Bonjour · Ciao · Olá · Hoi · Ahoj · مرحبا · こんにちは · 안녕하세요 · 你好.** Search is multilingual: the built-in embedding model reads twelve languages, so a German engram answers an English question and the other way round, and a domain that mixes languages needs no translation.
