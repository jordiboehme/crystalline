"""SkillOpt environment adapter for crystalline collaboration tasks."""
from __future__ import annotations

from skillopt.datasets.base import BatchSpec
from skillopt.envs.base import EnvAdapter

from envs.crystalline_collaboration.dataloader import (
    CrystallineCollaborationDataLoader,
)
from envs.crystalline_collaboration.rollout import run_batch
from envs.crystalline_routing.adapter import _resolve


class CrystallineCollaborationAdapter(EnvAdapter):
    def __init__(
        self,
        split_dir: str = "",
        data_path: str = "",
        ...
        self.dataloader = CrystallineCollaborationDataLoader(
            split_dir=_resolve(split_dir, "data/collaboration_split"),
            data_path=data_path,
    ...
    def get_task_types(self) -> list[str]:
        ...
        for item in (
            ...
            task_type = str(item.get("task_type") or "collaboration")
            if task_type not in seen:
                seen.append(task_type)
        return seen or ["collaboration"]
