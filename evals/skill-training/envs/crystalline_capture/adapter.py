"""SkillOpt environment adapter for crystalline capture tasks."""
from __future__ import annotations

from skillopt.datasets.base import BatchSpec
from skillopt.envs.base import EnvAdapter

from envs.crystalline_capture.dataloader import CrystallineCaptureDataLoader
from envs.crystalline_capture.rollout import run_batch
from envs.crystalline_routing.adapter import _resolve


class CrystallineCaptureAdapter(EnvAdapter):
    def __init__(
        self,
        split_dir: str = "",
        data_path: str = "",
        ...
        self.dataloader = CrystallineCaptureDataLoader(
            split_dir=_resolve(split_dir, "data/capture_split"),
            data_path=data_path,
    ...
    def get_task_types(self) -> list[str]:
        ...
        for item in (
            ...
            task_type = str(item.get("task_type") or "capture")
            if task_type not in seen:
                seen.append(task_type)
        return seen or ["capture"]
